...
if empty "$FORM_submit"; then
       ...
       config_get FORM_COM1_Modbus_Protect_Status $port COM1_Modbus_Protect_Status
       config_get FORM_COM1_Modbus_Protect_Key $port COM1_Modbus_Protect_Key
       ...
       eval FORM_COM1_Modbus_Protect_Status="\$FORM_${port}_COM1_Modbus_Protect_Status"
       eval FORM_COM1_Modbus_Protect_Key="\$FORM_${port}_COM1_Modbus_Protect_Key"
...
int|FORM_${port}_COM1_Modbus_Protect_Key|$port @TR<<TCP MODBUS Protect Key>>||$FORM_COM1_Modbus_Protect_Key
...
EOF
       ...
       [ "$?" = "0" ] && {
         ...
         uci_set "comport" "$port" "COM1_Modbus_Protect_Status" "$FORM_COM1_Modbus_Protect_Status"
         uci_set "comport" "$port" "COM1_Modbus_Protect_Key" "$FORM_COM1_Modbus_Protect_Key"
...
radio|${port}_COM1_Port_Status|$FORM_COM1_Port_Status|A|@TR<<Disable>>
radio|${port}_COM1_Port_Status|$FORM_COM1_Port_Status|B|@TR<<Enable>>
...
field|@TR<<MODBUS TCP Protection Status>>
radio|${port}_COM1_Modbus_Protect_Status|$FORM_COM1_Modbus_Protect_Status|A|@TR<<Disable>>
radio|${port}_COM1_Modbus_Protect_Status|$FORM_COM1_Modbus_Protect_Status|B|@TR<<Enable>>

field|@TR<<MODBUS TCP Protection Key>>
text|${port}_COM1_Modbus_Protect_Key|$FORM_COM1_Modbus_Protect_Key
