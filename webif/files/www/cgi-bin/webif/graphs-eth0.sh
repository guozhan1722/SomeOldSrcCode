...
header "Graphs" "eth0" "@TR<<Interface eth0>>"
...
?>
<center>
	<object type="image/svg+xml" data="/cgi-bin/webif/graph_if_svg.sh?if=<? echo -n eth0 ?>"
		width="500" height="250">
		<param name="src" value="/cgi-bin/webif/graph_if_svg.sh?if=<? echo -n eth0 ?>" />
