...
if empty "$FORM_submit"; then
       ...
       config_get FORM_COM2_Modbus_Protect_Status $port COM2_Modbus_Protect_Status
       config_get FORM_COM2_Modbus_Protect_Key $port COM2_Modbus_Protect_Key
       ...
       config_get FORM_COM2_C1222_Reg_to_Net $port COM2_C1222_Reg_to_Net
       config_get FORM_COM2_C1222_Log_Net_Comm $port COM2_C1222_Log_Net_Comm
       config_get FORM_COM2_C1222_Diff_Socket $port COM2_C1222_Diff_Socket
       config_get FORM_COM2_C1222_Reassembly_Packet $port COM2_C1222_Reassembly_Packet
       config_get FORM_COM2_C1222_Host_IP $port COM2_C1222_Host_IP
       config_get FORM_COM2_C1222_Host_Port $port COM2_C1222_Host_Port
       config_get FORM_COM2_C1222_Local_Port $port COM2_C1222_Local_Port
       ...
       eval FORM_COM2_Modbus_Protect_Status="\$FORM_${port}_COM2_Modbus_Protect_Status"
       eval FORM_COM2_Modbus_Protect_Key="\$FORM_${port}_COM2_Modbus_Protect_Key"
       ...
       eval FORM_COM2_C1222_Reg_to_Net="\$FORM_${port}_COM2_C1222_Reg_to_Net"
       eval FORM_COM2_C1222_Log_Net_Comm="\$FORM_${port}_COM2_C1222_Log_Net_Comm"
       eval FORM_COM2_C1222_Diff_Socket="\$FORM_${port}_COM2_C1222_Diff_Socket"
       eval FORM_COM2_C1222_Reassembly_Packet="\$FORM_${port}_COM2_C1222_Reassembly_Packet"
       eval FORM_COM2_C1222_Host_IP="\$FORM_${port}_COM2_C1222_Host_IP"
       eval FORM_COM2_C1222_Host_Port="\$FORM_${port}_COM2_C1222_Host_Port"
       eval FORM_COM2_C1222_Local_Port="\$FORM_${port}_COM2_C1222_Local_Port"
...
ip|FORM_${port}_COM2_C1222_Host_IP|$port @TR<<Host Server IP>>||$FORM_COM2_C1222_Host_IP
int|FORM_${port}_COM2_C1222_Host_Port|$port @TR<<Host Server Port>>||$FORM_COM2_C1222_Host_Port
int|FORM_${port}_COM2_C1222_Local_Port|$port @TR<<Local Server Port>>||$FORM_COM2_C1222_Local_Port

EOF

       [ "$?" = "0" ] && {
         uci_set "comport" "$port" "COM2_Port_Status" "$FORM_COM2_Port_Status"
         uci_set "comport" "$port" "COM2_Chanel_Mode" "$FORM_COM2_Chanel_Mode"
         uci_set "comport" "$port" "COM2_Data_Baud_Rate" "$FORM_COM2_Data_Baud_Rate"
         uci_set "comport" "$port" "COM2_Data_Format" "$FORM_COM2_Data_Format"
         uci_set "comport" "$port" "COM2_Flow_Control" "$FORM_COM2_Flow_Control"
         uci_set "comport" "$port" "COM2_Pre_Data_Delay" "$FORM_COM2_Pre_Data_Delay"
         uci_set "comport" "$port" "COM2_Post_Data_Delay" "$FORM_COM2_Post_Data_Delay"
         uci_set "comport" "$port" "COM2_Data_Mode" "$FORM_COM2_Data_Mode"
         uci_set "comport" "$port" "COM2_Character_Timeout" "$FORM_COM2_Character_Timeout"
         uci_set "comport" "$port" "COM2_Max_Packet_Len" "$FORM_COM2_Max_Packet_Len"
         uci_set "comport" "$port" "COM2_NoConnect_Data_Intake" "$FORM_COM2_NoConnect_Data_Intake"
         uci_set "comport" "$port" "COM2_QoS" "$FORM_COM2_QoS"
         uci_set "comport" "$port" "COM2_MODBUS_Mode" "$FORM_COM2_MODBUS_Mode"
         uci_set "comport" "$port" "COM2_Modbus_Protect_Status" "$FORM_COM2_Modbus_Protect_Status"
         uci_set "comport" "$port" "COM2_Modbus_Protect_Key" "$FORM_COM2_Modbus_Protect_Key"
         uci_set "comport" "$port" "COM2_IP_Protocol" "$FORM_COM2_IP_Protocol"

         case "$FORM_COM2_IP_Protocol" in
            "A")
               uci_set "comport" "$port" "COM2_T_Client_Server_Addr" "$FORM_COM2_T_Client_Server_Addr"
               uci_set "comport" "$port" "COM2_T_Client_Server_Port" "$FORM_COM2_T_Client_Server_Port"
               uci_set "comport" "$port" "COM2_T_Client_Timeout" "$FORM_COM2_T_Client_Timeout"
               ;;
            "B")
               uci_set "comport" "$port" "COM2_T_Server_Listen_Port" "$FORM_COM2_T_Server_Listen_Port"
               uci_set "comport" "$port" "COM2_T_Server_Timeout" "$FORM_COM2_T_Server_Timeout"
               ;;
            "C")
               uci_set "comport" "$port" "COM2_T_Client_Server_Addr" "$FORM_COM2_T_Client_Server_Addr"
               uci_set "comport" "$port" "COM2_T_Client_Server_Port" "$FORM_COM2_T_Client_Server_Port"
               ...
               ;;
            "D")
               uci_set "comport" "$port" "COM2_U_PtoP_Remote_Addr" "$FORM_COM2_U_PtoP_Remote_Addr"
               uci_set "comport" "$port" "COM2_U_PtoP_Remote_Port" "$FORM_COM2_U_PtoP_Remote_Port"
               uci_set "comport" "$port" "COM2_U_PtoP_Listen_Port" "$FORM_COM2_U_PtoP_Listen_Port"
               ;;
            "E")
               uci_set "comport" "$port" "COM2_UM_P_Multicast_Addr" "$FORM_COM2_UM_P_Multicast_Addr"
               uci_set "comport" "$port" "COM2_UM_P_Multicast_Port" "$FORM_COM2_UM_P_Multicast_Port"
               uci_set "comport" "$port" "COM2_UM_P_Listen_Port" "$FORM_COM2_UM_P_Listen_Port"
               uci_set "comport" "$port" "COM2_UM_P_TTL" "$FORM_COM2_UM_P_TTL"
               ;;
            "F")
               uci_set "comport" "$port" "COM2_UM_M_Remote_Addr" "$FORM_COM2_UM_M_Remote_Addr"
               uci_set "comport" "$port" "COM2_UM_M_Remote_Port" "$FORM_COM2_UM_M_Remote_Port"
               uci_set "comport" "$port" "COM2_UM_M_Multicast_Addr" "$FORM_COM2_UM_M_Multicast_Addr"
               uci_set "comport" "$port" "COM2_UM_M_Multicast_Port" "$FORM_COM2_UM_M_Multicast_Port"
               ;;
            "G")
               uci_set "comport" "$port" "COM2_UMTOM_Multicast_Addr" "$FORM_COM2_UMTOM_Multicast_Addr"
               uci_set "comport" "$port" "COM2_UMTOM_Multicast_Port" "$FORM_COM2_UMTOM_Multicast_Port"
               uci_set "comport" "$port" "COM2_UMTOM_Multicast_TTL" "$FORM_COM2_UMTOM_Multicast_TTL"
               uci_set "comport" "$port" "COM2_UMTOM_Listen_Multicast_Addr" "$FORM_COM2_UMTOM_Listen_Multicast_Addr"
               uci_set "comport" "$port" "COM2_UMTOM_Listen_Multicast_Port" "$FORM_COM2_UMTOM_Listen_Multicast_Port"
               ;;
            "H")
               uci_set "comport" "$port" "COM2_SMTP_Mail_Subject" "$FORM_COM2_SMTP_Mail_Subject"
               uci_set "comport" "$port" "COM2_SMTP_Server" "$FORM_COM2_SMTP_Server"
               uci_set "comport" "$port" "COM2_SMTP_Recipient" "$FORM_COM2_SMTP_Recipient"
               uci_set "comport" "$port" "COM2_SMTP_Buffer" "$FORM_COM2_SMTP_Buffer"
               uci_set "comport" "$port" "COM2_SMTP_Timeout" "$FORM_COM2_SMTP_Timeout"
               uci_set "comport" "$port" "COM2_SMTP_Transfer_Mode" "$FORM_COM2_SMTP_Transfer_Mode"
               ;;
            
            "I")
               uci_set "comport" "$port" "COM2_C1222_Reg_to_Net" "$FORM_COM2_C1222_Reg_to_Net"
               uci_set "comport" "$port" "COM2_C1222_Log_Net_Comm" "$FORM_COM2_C1222_Log_Net_Comm"
               uci_set "comport" "$port" "COM2_C1222_Diff_Socket" "$FORM_COM2_C1222_Diff_Socket"
               uci_set "comport" "$port" "COM2_C1222_Reassembly_Packet" "$FORM_COM2_C1222_Reassembly_Packet"
               uci_set "comport" "$port" "COM2_C1222_Host_IP" "$FORM_COM2_C1222_Host_IP"
               uci_set "comport" "$port" "COM2_C1222_Host_Port" "$FORM_COM2_C1222_Host_Port"
               uci_set "comport" "$port" "COM2_C1222_Local_Port" "$FORM_COM2_C1222_Local_Port"
               ;;
         esac
     }
...
field|@TR<<Com2 Port status>>
radio|${port}_COM2_Port_Status|$FORM_COM2_Port_Status|A|@TR<<Disable>>
radio|${port}_COM2_Port_Status|$FORM_COM2_Port_Status|B|@TR<<Enable>>

field|@TR<<Channel Mode>>
...
field|@TR<<TCP MODBUS Protection Status>>
radio|${port}_COM2_Modbus_Protect_Status|$FORM_COM2_Modbus_Protect_Status|A|@TR<<Disable>>
radio|${port}_COM2_Modbus_Protect_Status|$FORM_COM2_Modbus_Protect_Status|B|@TR<<Enable>>

field|@TR<<TCP MODBUS Protection Key>>
text|${port}_COM2_Modbus_Protect_Key|$FORM_COM2_Modbus_Protect_Key

field|@TR<<IP Protocol Config>>
...
text|${port}_COM2_SMTP_Transfer_Mode|$FORM_COM2_SMTP_Transfer_Mode
end_form

start_form|@TR<<C12.22 Configuration>>|${port}_C1222|hidden
field|@TR<<Register to Network>>|field_${port}_COM2_C1222_Reg_to_Net|hidden
radio|${port}_COM2_C1222_Reg_to_Net|$FORM_COM2_C1222_Reg_to_Net|B|@TR<<Enable>>
radio|${port}_COM2_C1222_Reg_to_Net|$FORM_COM2_C1222_Reg_to_Net|A|@TR<<Disable>>
field|@TR<<Log Network Communication>>|field_${port}_COM2_C1222_Log_Net_Comm|hidden
radio|${port}_COM2_C1222_Log_Net_Comm|$FORM_COM2_C1222_Log_Net_Comm|B|@TR<<Enable>>
radio|${port}_COM2_C1222_Log_Net_Comm|$FORM_COM2_C1222_Log_Net_Comm|A|@TR<<Disable>>
field|@TR<<Using Different Socket>>|field_${port}_COM2_C1222_Diff_Socket|hidden
radio|${port}_COM2_C1222_Diff_Socket|$FORM_COM2_C1222_Diff_Socket|B|@TR<<Enable>>
radio|${port}_COM2_C1222_Diff_Socket|$FORM_COM2_C1222_Diff_Socket|A|@TR<<Disable>>
field|@TR<<Reassembly Packet>>|field_${port}_COM2_C1222_Reassembly_Packet|hidden
radio|${port}_COM2_C1222_Reassembly_Packet|$FORM_COM2_C1222_Reassembly_Packet|B|@TR<<Enable>>
radio|${port}_COM2_C1222_Reassembly_Packet|$FORM_COM2_C1222_Reassembly_Packet|A|@TR<<Disable>>
field|@TR<<Host Server IP>>|field_${port}_COM2_C1222_Host_IP|hidden
text|${port}_COM2_C1222_Host_IP|$FORM_COM2_C1222_Host_IP
field|@TR<<Host Server Port>>|field_${port}_COM2_C1222_Host_Port|hidden
text|${port}_COM2_C1222_Host_Port|$FORM_COM2_C1222_Host_Port
field|@TR<<Local Server Port>>|field_${port}_COM2_C1222_Local_Port|hidden
text|${port}_COM2_C1222_Local_Port|$FORM_COM2_C1222_Local_Port
end_form"
...
javascript_forms="
       ...
       set_visible('field_${port}_COM2_C1222_Reg_to_Net', v);
       set_visible('field_${port}_COM2_C1222_Log_Net_Comm', v);
       set_visible('field_${port}_COM2_C1222_Diff_Socket', v);
       set_visible('field_${port}_COM2_C1222_Reassembly_Packet', v);
       set_visible('field_${port}_COM2_C1222_Host_IP', v);
       set_visible('field_${port}_COM2_C1222_Host_Port', v);
       set_visible('field_${port}_COM2_C1222_Local_Port', v); "
