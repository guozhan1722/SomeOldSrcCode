...
// Change 26770 SPIN_LOCK_UNLOCKED is deprecated since 2.6.19.
...
register_switch(struct switch_dev *dev, struct net_device *netdev)
{
	...
	printk(KERN_INFO "swconfig: switch_register()ed. Switch name:%s; %s. Netdev name:%s\n", dev->name, dev->devname, netdev->name);
