...
struct _mcastctl
{ 
    unsigned int srcip32;
    unsigned int srcmask32;
    unsigned int grpip32;
    unsigned int localip32;
    unsigned int remoteip32;
    char channel[12];
    char tunnel[8];
    signed char Niftunnel;
    signed char once;
    struct _mcastctl *last; 
    struct _mcastctl *next; 
};
extern struct _mcastctl *mcastctl;
extern int detectrp;
void init_tree(void);
