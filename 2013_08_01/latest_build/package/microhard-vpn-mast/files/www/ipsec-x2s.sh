...
EOF
        ...
        equal "$?" 0 && {
 	    uci_set "ipsec" "$FORM_x2s_name" "interface"       "br-wan"
...
<td><input name="tunnelinf" value="WAN" disabled="disabled"></td>
</tr>
...
footer_vpn "ipsec-s2s-summary.sh" "update_x2s" "$FORM_enabled br-wan" ?> 
