...
#if 0
#ident  "ACI $Id: //depot/sw/src/dk/mdk/manlib/mConfig.h#1 $, $Header: //depot/sw/src/dk/mdk/manlib/mConfig.h#1 $"
#endif
...
#define ART_SET_CD_ENDIAN(x, y) (gLibInfo.pLibDevArray[x]->devMap.SetCDEndian(x, y))
#define ART_GET_CD_ENDIAN(x) (gLibInfo.pLibDevArray[x]->devMap.GetCDEndian(x))
