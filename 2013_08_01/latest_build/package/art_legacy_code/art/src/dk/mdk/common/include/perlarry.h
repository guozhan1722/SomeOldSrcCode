...
#if 0
#ident  "ACI $Id: //depot/sw/branches/ART_V53/sw/src/dk/mdk/common/include/perlarry.h#1 $, $Header: //depot/sw/branches/ART_V53/sw/src/dk/mdk/common/include/perlarry.h#1 $"
#endif
