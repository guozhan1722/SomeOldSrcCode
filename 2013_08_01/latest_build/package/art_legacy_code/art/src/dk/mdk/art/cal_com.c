...
//					pLine = strtok(pLine," ;#");
            ...
            if(!sscanf(pLine, "%hd", &CalSetup.max_pcdac_11a)) {
            ...
            if(!sscanf(pLine, "%hd", &CalSetup.max_pcdac_11b)) {
            ...
            if(!sscanf(pLine, "%hd", &CalSetup.max_pcdac_11g)) {
            ...
            if(!sscanf(pLine, "%hd", &CalSetup.attempt_pcdac_11a)) {
            ...
            if(!sscanf(pLine, "%hd", &CalSetup.attempt_pcdac_11b)) {
            ...
            if(!sscanf(pLine, "%hd", &CalSetup.attempt_pcdac_11g)) {
...
*/
            ...
            pLine = strchr(pLine, '=');
            pLine = strtok(pLine, delimiters);
            if(!sscanf(pLine, "%hd", &CalSetup.targetPowerAntBRate)) {
...
// ofdm@2p4 test setup
            ...
            pLine = strchr(pLine, '=');
            pLine = strtok(pLine, delimiters);
            if(!sscanf(pLine, "%d", &CalSetup.goldenPPM)) {
            ...
            pLine = strchr(pLine, '=');
            pLine = strtok(pLine, delimiters);
            if(!sscanf(pLine, "%d", &CalSetup.numRetriesThruput)) {
...
//				printf("#################SNOOP: attenModel in calcommon = %d\n", CalSetup.attModel);
            ...
            pLine = strchr(pLine, '=');
            pLine = strtok(pLine, delimiters);
            if(!sscanf(pLine, "%d", &CalSetup.perPassLimit)) {
            ...
            pLine = strchr(pLine, '=');
            pLine = strtok(pLine, delimiters);
            if(!sscanf(pLine, "%d", &CalSetup.senPassLimit)) {
            ...
            pLine = strchr(pLine, '=');
            pLine = strtok(pLine, delimiters);
            if(!sscanf(pLine, "%d", &CalSetup.ppmMaxLimit)) {
            ...
            pLine = strchr(pLine, '=');
            pLine = strtok(pLine, delimiters);
            if(!sscanf(pLine, "%d", &CalSetup.ppmMaxQuarterLimit)) {
            ...
            pLine = strchr(pLine, '=');
            pLine = strtok(pLine, delimiters);
            if(!sscanf(pLine, "%hd", &goldenParams.channelStart)) {
            ...
            pLine = strchr(pLine, '=');
            pLine = strtok(pLine, delimiters);
            if(!sscanf(pLine, "%hd", &goldenParams.channelStop)) {
            ...
            pLine = strchr(pLine, '=');
            pLine = strtok(pLine, delimiters);
            if(!sscanf(pLine, "%hd", &goldenParams.measurementStep)) {
            ...
            pLine = strchr(pLine, '=');
            pLine = strtok(pLine, delimiters);
            if(!sscanf(pLine, "%d", &CalSetup.ppmMinLimit)) {
            ...
            pLine = strchr(pLine, '=');
            pLine = strtok(pLine, delimiters);
            if(!sscanf(pLine, "%d", &CalSetup.ppmMinQuarterLimit)) {
            ...
            pLine = strchr(pLine, '=');
            pLine = strtok(pLine, delimiters);
            if(!sscanf(pLine, "%d", &CalSetup.maskFailLimit)) {
...
*/
            ...
            pLine = strchr(pLine, '=');
            pLine = strtok(pLine, delimiters);
            if(!sscanf(pLine, "%d", &CalSetup.i_coeff_5G)) {
            ...
            pLine = strchr(pLine, '=');
            pLine = strtok(pLine, delimiters);
            if(!sscanf(pLine, "%d", &CalSetup.q_coeff_5G)) {
            ...
            pLine = strchr(pLine, '=');
            pLine = strtok(pLine, delimiters);
            if(!sscanf(pLine, "%d", &CalSetup.i_coeff_2G)) {
            ...
            pLine = strchr(pLine, '=');
            pLine = strtok(pLine, delimiters);
            if(!sscanf(pLine, "%d", &CalSetup.q_coeff_2G)) {
...
*/
		...
		if (pLine != NULL)
		{
			pTestSet[mode]->pTestChannel[ii].TEST_ZERO_POWER = (A_UINT16) strtoul(pLine, NULL, 2);;
		} else{
