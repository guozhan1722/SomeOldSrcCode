...
#if 0
#ident  "ACI $Id: //depot/sw/branches/ART_V53/sw/src/dk/mdk/devlib/ar5211/mEEP211.c#1 $, $Header: //depot/sw/branches/ART_V53/sw/src/dk/mdk/devlib/ar5211/mEEP211.c#1 $"
#endif
