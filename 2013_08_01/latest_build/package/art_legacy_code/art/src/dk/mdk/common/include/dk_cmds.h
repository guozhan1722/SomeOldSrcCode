...
#if 0
#ident	"ACI $Id: //depot/sw/branches/ART_V53/sw/src/dk/mdk/common/include/dk_cmds.h#4 $, $Header: //depot/sw/branches/ART_V53/sw/src/dk/mdk/common/include/dk_cmds.h#4 $"
#endif
...
#define EEPROM_SPUR_11A_START 0x138
#define EEPROM_SPUR_11G_START 0x13d
#define EEPROM_SPUR_11A_SIZE  (EEPROM_SPUR_11G_START - EEPROM_SPUR_11A_START)
#define EEPROM_SPUR_11G_SIZE  (0x150 - EEPROM_SPUR_11G_START)
#define EEPROM_SPUR_ANCHORED  0x8000
...
#ifndef AR6000_COMM
	RECV_FRAME_CMD_ID,					// 122
	RX_DATA_SNIFF_CMD_ID,				// 123
	M_RX_ENABLE_DECOMP_CMD_ID,			// 124
#else
	RECV_FRAME_CMD_ID,					// 123
	M_EEPROM_READ_LOCS_CMD_ID,				//124
	GET_REF_CLK_SPEED_CMD_ID,				//125
	SLEEP_CMD_ID,				//126
	RX_DATA_SNIFF_CMD_ID,				// 127 - was 124
	M_RX_ENABLE_DECOMP_CMD_ID,			// 128 - was 125
#endif
    SET_ADF4350_FREQ_CMD_ID=130,			// 130
    GET_ADF4350_FREQ_CMD_ID=131,			// 131
};
...
typedef struct
{
	struct spur
	{
		A_UINT32 _2p4g[EEPROM_SPUR_11G_SIZE];
		A_UINT32 _5g[EEPROM_SPUR_11A_SIZE];
	} SPUR;
    ...
    A_INT8 devNum;
  	...
  	union {
			...
			struct pciWriteCmd {
					A_UINT32 length;
#ifndef AR6000_COMM
					PCI_VALUES pPciValues[MAX_PCI_ENTRIES];
#else
		...
		struct enableDecompCmd {
			A_UCHAR macAddress[6]; 
         ...
         //	} MEM_FREE_CMD;
    		...
    		struct resetDeviceExtraCmd {
      			struct resetDeviceCmd reset;
      			RESET_DEVICE_EXTRA extra;
    		} RESET_DEVICE_EXTRA_CMD;
