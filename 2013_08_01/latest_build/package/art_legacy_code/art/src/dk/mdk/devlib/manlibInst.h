...
#define gpibRSC(args...) GPIB_BAD_CALL()
#define gpibRSP(args...) ({ GPIB_BAD_CALL(); -1; })
#define gpibSIC(args...) GPIB_BAD_CALL()
#define gpibONL(args...) GPIB_BAD_CALL()
#define gpibWrite(args...) GPIB_BAD_CALL()
#define gpibClear(args...) GPIB_BAD_CALL()
#define gpibRead(args...) ({ GPIB_BAD_CALL(); ""; })
