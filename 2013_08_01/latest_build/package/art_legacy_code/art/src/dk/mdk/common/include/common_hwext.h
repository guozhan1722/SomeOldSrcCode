...
#if 0
#ident  "ACI $Id: //depot/sw/branches/ART_V53/sw/src/dk/mdk/common/include/common_hwext.h#1 $, $Header: //depot/sw/branches/ART_V53/sw/src/dk/mdk/common/include/common_hwext.h#1 $"
#endif
...
#ifdef SOC_LINUX
A_UINT32 apRegRead32 (A_UINT32 devIndex,  A_UINT32 address);
void apRegWrite32 ( A_UINT32 devIndex, A_UINT32 address, A_UINT32  value);
