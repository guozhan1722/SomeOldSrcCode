...
#if 0
#ident  "ACI $Id: //depot/sw/branches/ART_V53/sw/src/dk/mdk/devmld/MLIBif.c#2 $, $Header: //depot/sw/branches/ART_V53/sw/src/dk/mdk/devmld/MLIBif.c#2 $"
#endif
