...
//printf ("SNOOP: channel = %d, idxL = %d, idxR = %d, pdOverlap*2 = %d\n", channel, idxL, idxR, pdGainOverlap_t2);
...
//printf("SNOOP: VpdTable_I[%d][%d] = %d\n", numPdGainsUsed, kk, VpdTable_I[numPdGainsUsed][kk]);
...
//printf("SNOOP: called with pdGain = %d, Pmin = %d, Pmax = %d, numIntercepts = %d\n",
//	   pdGainIdx, Pmin, Pmax, numIntercepts);
//for(i = 0; i < numIntercepts; i++) {
//	printf("SNOOP: i = %d, pwd = %d, Vpd = %d\n", i, pwrList[i], VpdList[i]);
//}
