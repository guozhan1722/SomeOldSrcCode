...
# ADD CPP /nologo /MTd /W3 /Gm /GX /ZI /Od /I "..\devmld" /I "..\kerplug" /I "..\devlib\ar5212" /I "..\devlib\ar2413" /I "..\..\..\include" /I "..\devlib" /I "..\mdk" /I "..\common" /I "..\common\include" /I "..\client\include" /I "..\client\sta\anwi\anwi_wdm\inc" /D "_DEBUG" /D "_WINDOWS" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "_MLD" /D "ART_BUILD" /D "CUSTOMER_REL" /D "NO_LIB_PRINT" /D "ANWI" /FR /YX /FD /GZ /c
...
# ADD LINK32 ws2_32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib devlib.lib setupapi.lib /nologo /subsystem:console /debug /machine:I386 /out:"Debug/art.exe" /pdbtype:sept /libpath:"..\devlib\Debug" /libpath:"..\mlibsrc\Debug"
...
# ADD CPP /nologo /MT /W3 /GX /O2 /I "..\art" /I "..\devlib\ar2413" /I "..\kerplug" /I "..\devlib\ar5212" /I "..\..\..\include" /I "..\devlib" /I "..\mdk" /I "..\common" /I "..\common\include" /I "..\client\include" /I "..\client\sta\anwi\anwi_wdm\inc" /I "..\..\..\..\branches\4oDev\src\transport\usb\host\test\sys\\" /D "NDEBUG" /D "ANWI" /D "ART_BUILD" /D "_WINDOWS" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "_MLD" /D "CUSTOMER_REL" /D "NO_LIB_PRINT" /FR /YX /FD /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib devlib.lib ws2_32.lib setupapi.lib /nologo /subsystem:console /machine:I386 /out:"customerRel/art.exe" /libpath:"..\devlib\customerRel"
