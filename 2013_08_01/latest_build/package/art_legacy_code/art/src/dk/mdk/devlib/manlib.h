...
#if 0
#ident  "ACI $Id: //depot/sw/src/dk/mdk/manlib/manlib.h#1 $, $Header: //depot/sw/src/dk/mdk/manlib/manlib.h#1 $"
#endif
...
typedef struct _libParams
{
	...
	A_UINT32 enableCompression;      // Set to enable compression/decompression
} LIB_PARAMS;
...
typedef struct DeviceMap {
	...
	void (*SetCDEndian)(A_UINT32 devNum, A_UINT32 endian);
	A_UINT32 (*GetCDEndian)(A_UINT32 devNum);
} DEVICE_MAP;   
...
MANLIB_API void setRegisterPatch(int devNum, int patch_no);
MANLIB_API void setSpurFrequency(int devNum, A_UINT32 *_5g, A_UINT32 *_2p4g);
...
MANLIB_API void checkBeaconRSSI(A_UINT32 devNum, A_UINT32 timeout, A_UINT32 remoteStats,
				A_UINT32 enableCompare, A_UCHAR *dataPattern, A_UINT32 dataPatternLength,A_CHAR *GIVEN_SSID,A_INT32 rssiThreshold,A_INT32 * result);
...
MANLIB_API void forcePDADCTable (A_UINT32 devNum, A_UINT16 *pPdadcs, A_UINT16 *pGainBoundaries);
...
#include "mIds.h"
#define isNala(devID)           ((devID) == SW_DEVICE_ID_NALA)
