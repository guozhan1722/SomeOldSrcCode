...
#if 0
#ident  "ACI $Id: //depot/sw/branches/ART_V53/sw/src/dk/mdk/devlib/mDevtbl.h#2 $, $Header: //depot/sw/branches/ART_V53/sw/src/dk/mdk/devlib/mDevtbl.h#2 $"
#endif
...
typedef struct macAPITable
{
	...
	A_UINT32	(*txGetDescRate)(A_UINT32, A_UINT32);
...
{
	A_UINT16		    deviceID;
	const ANALOG_REV	    *pAnalogRevs;
	A_UINT16			numAnalogRevs;
	const A_UINT16		*pMacRevs;
	A_UINT16			numMacRevs;
	A_UINT16			swDeviceID;
...
typedef struct DevicePatchIdata
{
	ATHEROS_REG_FILE	*pInitRegs;
	MODE_INFO			*pModeValues;
} DEVICE_PATCH_IDATA;
...
extern void patch_specific_idata(DEVICE_INIT_DATA *dev_idata, int patch_no);
