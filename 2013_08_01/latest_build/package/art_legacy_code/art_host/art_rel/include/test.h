...
//max and min params
#define PCDAC_MIN				1
#define PCDAC_MAX				106 //63
//#define PCDAC_MAX_DERBY2		127
#define PCDAC_MAX_DERBY2		80 //63
...
#define SSID_TEST_MASK   0x00000200
#define GET_MAC_ADDR_MASK   0x00000400
...
//	A_CHAR		cmdLineDutCardType[112];
	...
	A_UINT32    sniffTimeout;
	A_UINT32    sniffBufferSize;
	A_UINT32    sniffNumBuffers;
#ifdef __ATH_DJGPPDOS__
	A_INT32		bus;
	A_INT32         devInPci;
#endif
	A_BOOL		enableCompression;
	A_CHAR     SSID[100];
	A_CHAR     macAddrFileName[100];
	A_UINT16   offsetCalPower2x;
} MLD_CONFIG;
