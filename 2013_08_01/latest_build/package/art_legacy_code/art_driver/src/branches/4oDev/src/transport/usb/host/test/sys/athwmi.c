...
#define WMI_ATHUSB_DRIVER_INFORMATION 0

DEFINE_GUID (ATHUSB_WMI_STD_DATA_GUID, 
0xBBA21300, 0x6DD3, 0x11d2, 0xB8, 0x44, 0x00, 0xC0, 0x4F, 0xAD, 0x51, 0x71);

WMIGUIDREGINFO AthUsbWmiGuidList[1] = { {

        &ATHUSB_WMI_STD_DATA_GUID, 1, 0 // driver information
    }
};
...
--*/
{
    ...
    DeviceExtension->WmiLibInfo.GuidCount = 
          sizeof (AthUsbWmiGuidList) / sizeof (WMIGUIDREGINFO);

    DeviceExtension->WmiLibInfo.GuidList           = AthUsbWmiGuidList;
    DeviceExtension->WmiLibInfo.QueryWmiRegInfo    = AthUsb_QueryWmiRegInfo;
    DeviceExtension->WmiLibInfo.QueryWmiDataBlock  = AthUsb_QueryWmiDataBlock;
    DeviceExtension->WmiLibInfo.SetWmiDataBlock    = AthUsb_SetWmiDataBlock;
    DeviceExtension->WmiLibInfo.SetWmiDataItem     = AthUsb_SetWmiDataItem;
...
--*/
{
    ...
    AthUsb_DbgPrint(3, (WMIMinorFunctionString(irpStack->MinorFunction)));
    ...
    AthUsb_DbgPrint(3, ("AthUsb_DispatchSysCtrl::"));
...
--*/
{
    ...
    AthUsb_DbgPrint(3, ("AthUsb_QueryWmiRegInfo - begins\n"));
    ...
    *Pdo          = deviceExtension->PhysicalDeviceObject;
    ...
    AthUsb_DbgPrint(3, ("AthUsb_QueryWmiRegInfo - ends\n"));
...
--*/
{
    ...
    AthUsb_DbgPrint(3, ("AthUsb_QueryWmiDataBlock - begins\n"));
    ...
    case WMI_ATHUSB_DRIVER_INFORMATION:

        size = sizeof(ULONG) + modelNameLen + sizeof(USHORT);

        if (OutBufferSize < size ) {

            AthUsb_DbgPrint(3, ("OutBuffer too small\n"));
    ...
    AthUsb_DbgPrint(3, ("AthUsb_QueryWmiDataBlock - ends\n"));
...
--*/
{
    ...
    AthUsb_DbgPrint(3, ("AthUsb_SetWmiDataItem - begins\n"));
    ...
    AthUsb_DbgPrint(3, ("AthUsb_SetWmiDataItem - ends\n"));
...
--*/
{
    ...
    AthUsb_DbgPrint(3, ("AthUsb_SetWmiDataBlock - begins\n"));
    ...
    AthUsb_DbgPrint(3, ("AthUsb_SetWmiDataBlock - ends\n"));
