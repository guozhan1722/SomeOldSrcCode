...
$(call KernelPackage/usb-serial/Depends,)
  TITLE:=Support for WWAN device
  KCONFIG:=CONFIG_USB_SERIAL_WWAN
  FILES:=$(LINUX_DIR)/drivers/usb/serial/usb_wwan.$(LINUX_KMOD_SUFFIX)
  AUTOLOAD:=$(call AutoLoad,63,usb_wwan)
endef

define KernelPackage/usb-serial-wwan/description
 Kernel support for WWAN USB-to-Serial Device
endef
