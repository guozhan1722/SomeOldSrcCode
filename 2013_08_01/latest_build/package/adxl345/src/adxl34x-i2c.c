				       ...
				       const struct i2c_device_id *id)
{
	struct adxl34x *ac;
	int error;
    printk(KERN_ALERT "adxl34x_i2c_probe...\n");
    ...
    printk(KERN_ALERT "adxl34x_i2c_probe...i2c_check_functionality(client->adapter, I2C_FUNC_SMBUS_READ_I2C_BLOCK) return %d\n", 
    ...
    printk(KERN_ALERT "leave adxl34x_i2c_probe...\n");
...
{
    printk(KERN_ALERT "Hello adxl34x_i2c_init\n");
...
{
    printk(KERN_ALERT "Bye adxl34x_i2c_exit\n");
