...
header "Tools" "Network Traffic" "@TR<<Vnstat - Network Traffic Monitor tool>>" '' "$SCRIPT_NAME"
...
cat <<EOF
        <tbody>
            <tr>
                <td>
                    <img  width="100%" src="/vnstat/vnstat_${interface}_s.png" alt="${interface} Summary" />
                </td>
                <td>
                    <img  width="100%" src="/vnstat/vnstat_${interface}_h.png" alt="${interface} Hourly" />
                </td>
            </tr>
            <tr>
                <td valign="top">
                    <img width="100%" src="/vnstat/vnstat_${interface}_d.png" alt="${interface} Daily" />
                </td>
                <td valign="top">
                    <img width="100%" src="/vnstat/vnstat_${interface}_t.png" alt="${interface} Top 10" />
                    <br />
                    <img width="100%" id="graphs_vnstat_monthly" src="/vnstat/vnstat_${interface}_m.png" alt="${interface} Monthly" />
                </td>
            </tr>
        </tbody>
EOF
...
footer_nosubmit ?>
<!--
##WEBIF:name:Tools:998:Network Traffic
-->
