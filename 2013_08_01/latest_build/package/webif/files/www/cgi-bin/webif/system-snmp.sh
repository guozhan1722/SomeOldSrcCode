...
radio|${cfg}_NetWork_SNMP_Listen_Protocol|$FORM_NetWork_SNMP_Listen_Protocol|A|@TR<<UDP>>
radio|${cfg}_NetWork_SNMP_Listen_Protocol|$FORM_NetWork_SNMP_Listen_Protocol|B|@TR<<TCP>>
