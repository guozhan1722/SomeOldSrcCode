...
/* LIBGNOKII_VERSION_MAJOR = GNOKII_MAJOR - GNOKII_MINOR
 * LIBGNOKII_VERSION_MINOR = GNOKII_MINOR
 * LIBGNOKII_VERSION_RELEASE = GNOKII_RELEASE
 */
#define LIBGNOKII_VERSION_STRING "3.5.0"
#define LIBGNOKII_VERSION_MAJOR 3
#define LIBGNOKII_VERSION_MINOR 5
...
GNOKII_API void gn_lib_busterminate(struct gn_statemachine **state);
GNOKII_API void gn_lib_businit(gn_data **data, struct gn_statemachine **state);
...
GNOKII_API gn_error gn_get_datetime(gn_data *data, struct gn_statemachine *state);
