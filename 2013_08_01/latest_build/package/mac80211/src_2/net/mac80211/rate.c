...
#endif /* CONFIG_MICROHARD_TXRATE_MCS */
			   ...
			   struct ieee80211_tx_rate_control *txrc)
{
	...
	//	printk(KERN_DEBUG "rate.c rate_control_get_rate 0x%02x\n",mcs_mask[i]);
	//}
#endif
	if (mask != (1 << txrc->sband->n_bitrates) - 1) {
		...
		//for (i = 0; i < IEEE80211_HT_MCS_MASK_LEN; i++){
		//	printk(KERN_DEBUG "rate.c rate_control_get_rate filter out 0x%02x\n",mcs_mask[i]);
		//}
