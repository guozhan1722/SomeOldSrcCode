...
/* JDBG:fixed the repeater mode problem under wep encryption*/
#ifdef CONFIG_MICROHARD
    if (strcmp("rep", sdata->name+6) == 0){
        if( sdata->keys[key_idx] != NULL )
				      ...
				      const struct cfg80211_bitrate_mask *mask)
{
	...
	int i;
        ...
        //	printk(KERN_DEBUG "cfg80211_bitrate_mask 0x%02x\n", mask->control[1].mcs[i]);
        //}
	...
	for (i = 0; i < IEEE80211_NUM_BANDS; i++){
        ...
        //for (i = 0; i < IEEE80211_HT_MCS_MASK_LEN; i++){
        //	printk(KERN_DEBUG "cfg80211 0x%02x\n", sdata->rc_rateidx_mcs_mask[1][i]);
        //}
