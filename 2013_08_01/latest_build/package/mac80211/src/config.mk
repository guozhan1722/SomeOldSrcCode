...
# This configurable setting for transmitting in non-standard frequency. 
# we managed to tx/rx at 2.39GHz in channel
# CONFIG_NON_STANDARD_FREQ=y

# enable ATH5K extend
# this is the microhard AR5414 driver extension project
# targeted to enable half/quarter/turbo rate as well as DFS
CONFIG_ATH5K_EXTEND=y

# CONFIG_ATH5K_ART=y

# Microhard modified 4addr wds bridge
CONFIG_MICROHARD_WDS=y

# this modification is to enable the hw encryption in ap mode
# the low throughput in wpa2 issue is therefore fixed
CONFIG_MICROHARD_HW_ENCRYPT=y

CONFIG_CFG80211=m
CONFIG_CFG80211_DEFAULT_PS=y
# CONFIG_CFG80211_DEBUGFS=y

ifeq ($(CONFIG_ATH5K_EXTEND),y)
