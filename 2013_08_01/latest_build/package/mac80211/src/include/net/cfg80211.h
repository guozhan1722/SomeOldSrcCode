...
#ifdef MICROHARD
/* new functions */
	int	(*set_root_mac)(struct wiphy *wiphy, struct net_device *dev,
				  u8 *root, u8 *next_hop);
	int	(*set_root_flag)(struct wiphy *wiphy, 
					struct net_device *dev, bool flag);
	int	(*get_root)(struct wiphy *wiphy, struct net_device *dev);
	int 	(*ap_join_mesh)(struct wiphy *wiphy, struct net_device *dev);
	int 	(*set_portal_flag)(struct wiphy *wiphy, 
					struct net_device *dev,	bool flag);
	int     (*trace_path)(struct wiphy *wiphy, struct net_device *dev, u8 *dst);
...
/* new functions: end */
	...
	int	(*config_op_ath5k_art_cmd)(struct wiphy *wiphy, void *data, int len);
#endif
