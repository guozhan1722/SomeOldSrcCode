...
#define DEFAULT_MIBDIRS "/etc/config:/etc/mibs"
...
#define USE_INTERNAL_MD5 1//added for test harvey
...
#define WORDS_BIGENDIAN 1 //harvey
...
#define SNMPLIBPATH "/etc/config"
#define SNMPSHAREPATH "/etc/config"
#define SNMPCONFPATH "/etc/config"
...
#define PROC_NET_DEV_HAS_COMPRESSED 1 //harvey
...
#define ENTERPRISE_OID			21703
#define ENTERPRISE_MIB			1,3,6,1,4,1,21703
#define ENTERPRISE_DOT_MIB		1.3.6.1.4.1.21703
...
#define PRODUCT_ID 300

#define SYSTEM_MIB		1,3,6,1,4,1,21703,PRODUCT_ID
#define SYSTEM_DOT_MIB		1.3.6.1.4.1.21703.PRODUCT_ID
...
#define NOTIFICATION_MIB		1,3,6,1,4,1,21703,101
#define NOTIFICATION_DOT_MIB		1.3.6.1.4.1.21703.101
...
#define CONFIGURE_OPTIONS "\" --prefix=/usr --without-opaque-special-types --without-root-access --with-out-transports=Unix '--with-out-mib-modules=agentx agent_mibs' --with-mib-modules=tunnel --with-enterprise-oid=14358 --with-defaults --enable-shared=no --enable-static=yes\""
...
//#define USE_OPENSSL 1 //added by harvey for test
