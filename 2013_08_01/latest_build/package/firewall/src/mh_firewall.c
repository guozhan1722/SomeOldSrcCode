...
void debug_struct(struct fw_rules *fwrules_head)
{
    ...
    while (p_rule->next != NULL) {
        ...
        printf(" src_ip_to: %s ",p_rule->src_ip_to);
        ...
        printf(" dest_ip: %s ",p_rule->dest_ip);
        printf(" dest_ip_to: %s ",p_rule->dest_ip_to);
        ...
        printf(" ruleset: %s",p_rule->ruleset);
...
static int add_rule(struct fw_rules *fwrules_head)
{
    ...
    if(strcmp(p_rule->src_ip,"")!=0){
        strcat(argstr, "-m iprange --src-range ");
        strcat(argstr, p_rule->src_ip);
        if(strcmp(p_rule->src_ip_to,"")!=0){
            strcat(argstr, "-");
            strcat(argstr, p_rule->src_ip_to);
        }
        strcat(argstr, " ");
    }
    ...
    if(strcmp(p_rule->dest_ip,"")!=0){
        strcat(argstr, "-m iprange --dst-range ");
        strcat(argstr, p_rule->dest_ip);
        if(strcmp(p_rule->dest_ip_to,"")!=0){
            strcat(argstr, "-");
            strcat(argstr, p_rule->dest_ip_to);
        }
        strcat(argstr, " ");
    }

    if((strcmp(p_rule->dest_port,"")!=0) && (strcmp(p_rule->dest_port,"0")!=0)) {
        strcat(argstr, "--dport ");
...
static int excu_rule(struct fw_rules *fwrules_head, int router)
{
    struct fw_rules *p_rule;
    char ori_proto[32];
    ...
    while (p_rule->next != NULL) {
        ...
        bzero(ori_proto,sizeof(ori_proto));
        strcpy(ori_proto, p_rule->proto);

        if (router == 1) {
    
            if((strcmp(p_rule->src,"")==0)&&(strcmp(p_rule->dest,"")==0)) {
                /*add wan input chain*/
                strcpy(p_rule->ZONE,"zone_wan");
                strcpy(p_rule->TARGET,p_rule->target);
                strcpy(p_rule->proto, ori_proto);
                
                if(strcmp(p_rule->proto,"tcpudp")==0) {
                    ...
                    strcpy(p_rule->proto,"udp");
                    add_rule(p_rule);
                    strcpy(p_rule->proto,"icmp");
                    add_rule(p_rule);
                }else {
                    add_rule(p_rule);
                }
    
                /*add wan2 input chain*/
                strcpy(p_rule->ZONE,"zone_wan2");
                strcpy(p_rule->TARGET,p_rule->target);
                strcpy(p_rule->proto, ori_proto);
                ...
                /*add lan to wan forwarding chain*/
                strcpy(p_rule->ZONE,"zone_lan_forward");
                strcpy(p_rule->TARGET,"zone_wan_");
                strcat(p_rule->TARGET,p_rule->target);
                strcpy(p_rule->proto, ori_proto);
                if(strcmp(p_rule->proto,"tcpudp")==0) {
                    strcpy(p_rule->proto,"tcp");
                ...
                /*add lan to wan2 forwarding chain*/
                strcpy(p_rule->ZONE,"zone_lan_forward");
                strcpy(p_rule->TARGET,"zone_wan2_");
                strcat(p_rule->TARGET,p_rule->target);
                strcpy(p_rule->proto, ori_proto);
                if(strcmp(p_rule->proto,"tcpudp")==0) {
                    strcpy(p_rule->proto,"tcp");
                ...
                /*add wan to lan forwarding chain*/
                strcpy(p_rule->ZONE,"zone_wan_forward");
                strcpy(p_rule->TARGET,"zone_lan_");
                strcat(p_rule->TARGET,p_rule->target);
                strcpy(p_rule->proto, ori_proto);
                if(strcmp(p_rule->proto,"tcpudp")==0) {
                    strcpy(p_rule->proto,"tcp");
                ...
                /*add wan2 to lan forwarding chain*/
                strcpy(p_rule->ZONE,"zone_wan2_forward");
                strcpy(p_rule->TARGET,"zone_lan_");
                strcat(p_rule->TARGET,p_rule->target);
                strcpy(p_rule->proto, ori_proto);
                if(strcmp(p_rule->proto,"tcpudp")==0) {
            ...
            } else if ((strcmp(p_rule->src,"")!=0)&&(strcmp(p_rule->dest,"")==0)) {
                ...
                /*add src to another port forwording chain*/
                if (strcmp(p_rule->src,"wan")==0) {
                    /*add wan to lan forwarding chain*/
                    strcpy(p_rule->ZONE,"zone_wan_forward");
                    strcpy(p_rule->TARGET,"zone_lan_");
                    strcat(p_rule->TARGET,p_rule->target);
                ...
                } else if (strcmp(p_rule->src,"wan2")==0) {
                    /*add wan2 to lan forwarding chain*/
                    strcpy(p_rule->ZONE,"zone_wan2_forward");
                    strcpy(p_rule->TARGET,"zone_lan_");
                    strcat(p_rule->TARGET,p_rule->target);
                ...
                } else if (strcmp(p_rule->dest,"wan2")==0) {
                        /*add wan2 input chain*/
                        strcpy(p_rule->ZONE,"zone_wan2");
                        strcpy(p_rule->TARGET,p_rule->target);
                        strcpy(p_rule->proto, ori_proto);
                ...
                if (strcmp(p_rule->dest,p_rule->src)==0) {
    ...
    while (p_rule->next != NULL) {
        ...
        while(tmp_rule->next!=NULL) {
            ...
            if (pri_s > pri_p) {
                ...
                strcpy(bri_rule.src_ip_to, p_rule->src_ip_to);
                ...
                strcpy(bri_rule.dest_ip_to, p_rule->dest_ip_to);
                ...
                strcpy(p_rule->src_ip_to, tmp_rule->src_ip_to);
                ...
                strcpy(p_rule->dest_ip_to, tmp_rule->dest_ip_to);
                ...
                strcpy(tmp_rule->src_ip_to, bri_rule.src_ip_to);
                ...
                strcpy(tmp_rule->dest_ip_to, bri_rule.dest_ip_to);
...
static int get_rule(struct uci_context * ctx, char *fw_section, struct fw_rules *fwrules_head)
{
    ...
    for(i=0;i<MAX_RULES;i++) {
        ...
        bzero(p_rule->src_ip_to,sizeof(p_rule->src_ip_to));
        ...
        bzero(p_rule->dest_ip_to,sizeof(p_rule->dest_ip_to));
        ...
        get_option_by_section_name(ctx, CONFILE, section, "src_ip_to", rBuff); 
        if (strcmp(rBuff,"")!=0) {
            strcpy(p_rule->src_ip_to, rBuff);
            last++;
        }
        ...
        get_option_by_section_name(ctx, CONFILE, section, "dest_ip_to", rBuff); 
        if (strcmp(rBuff,"")!=0) {
            strcpy(p_rule->dest_ip_to, rBuff);
            last++;
        }
...
int main(int argc, char *argv[])
{
    ...
    get_option_by_section_name(ctx, "system", "@system[0]", "systemmode", rBuff); 
    if((strcmp(rBuff,"router")==0) || (strcmp(rBuff,"gateway")==0) ){
        is_router=1;
    } else {
        is_router=0;
    }
